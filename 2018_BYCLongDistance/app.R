  ...
  fluidRow(
   column(6, 
          ...
          sliderInput("endtime", "Visible Time",
                      min=as.POSIXct("2018-09-15 19:00:00 GMT"), 
                      max=as.POSIXct("2018-09-16 01:00:00 GMT"), 
                      value=c(as.POSIXct("2018-09-15 19:00:00 GMT"), as.POSIXct("2018-09-16 01:00:00 GMT") ), 
